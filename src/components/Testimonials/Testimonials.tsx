...
import videoP from "../../assets/pixels.mp4"
  ...
  return (
    <section id="testimonials">
      <div className="relative">
        ...
        <div className="mx-4 md:text-left text-center">
          <div className="min-h-screen flex justify-center">
            <div className="grid md:grid-cols-2 grid-cols-1 gap-4 items-center z-10">
              <div className="max-w-lg text-center md:text-left order-1 md:order-none mb-24 md:mb-0">
                <h2 className="text-4xl font-bold text-gray-100 tracking-tight">
                  The Art <br className="hidden sm:block lg:hidden" /> of
                  Streamlining for Effortless Elegance and Clarity
                </h2>
                <p className="mt-4 text-gray-300">
                  Objectives are simply aspirations with a timeline
                </p>
